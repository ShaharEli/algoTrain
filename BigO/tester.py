import big_O as big_o
# Generating random test strings of length 100
def sample_strings(n): return big_o.datagen.strings(100)
...
def non_repetitive(sample_string):
    ...
    non_repetitive_char = next(
        (ele for ele in string_list if string_list.count(ele) == 1), None)
